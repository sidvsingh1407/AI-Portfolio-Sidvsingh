...
export const contentData: PortfolioData = {
  ...
  "projects": [
    { 
      ...
      "problem": "Manual lead follow-up was slow and impersonal.", 
      "context": "The sales team was losing potential deals because they couldn't keep up with follow-ups, leading to a leaky pipeline and missed revenue opportunities.", 
      "approach": "I designed and built a system using Make.com and the GPT-4 API to automatically generate personalized follow-up emails based on lead data in HubSpot. The system also tracks replies, updates the CRM, and schedules the next action.", 
      "outcome": "Reduced manual email work by 90% and increased qualified lead response rate by 25% within the first month.", 
      "toolkit": [
        {"group": "AI & Automation", "tools": ["GPT-4 API", "Make.com", "Workflow Automation"]}, 
        {"group": "Data & Execution", "tools": ["HubSpot API", "Prompt Engineering", "System Integration"]}
      ] 
    },
    { 
      "id": "agent-2", 
      "slug": "automated-market-research", 
      "category": "agentic-systems", 
      "title": "Automated Market Research Agent", 
      "problem": "Market research was a time-consuming manual process.", 
      "context": "The marketing team was spending over 10 hours a week manually tracking competitor websites and news, causing them to react slowly to market shifts.", 
      "approach": "I deployed a research agent using Puppeteer for web scraping and the Claude API for summarization. The agent runs on a schedule, scrapes target sites, and delivers a concise intelligence digest via email.", 
      "outcome": "Saved the team 10+ hours per week and delivered consistently sharp, timely market insights.", 
      "toolkit": [
        {"group": "AI & Automation", "tools": ["Claude API", "Puppeteer", "Cron Jobs"]}, 
        {"group": "Data & Execution", "tools": ["Web Scraping", "Data Synthesis", "Node.js"]}
      ] 
    },
    { 
      "id": "vibe-1", 
      ...
      "description": "A prototype for a B2B crowdfunding platform where vetted startups meet sophisticated investors.", 
      "images": [
        {"src": "https://picsum.photos/seed/dashboard/1200/800", "alt": "Dashboard UI", "hint": "dashboard ui", "width": 1200, "height": 800}
      ] 
    }
  ]
};
